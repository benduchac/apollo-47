export const NORMAL_SCENARIOS = [
 { 
  ...
  roles: [
    ...
    { id: "MedOfficer", label: "Medical Officer", isPrimary: false, briefing: "You're monitoring the Geologist's exertion levels in their suit. Your goal: Keep them safe while they work." }
  ]
},
{ 
...
{ 
  ...
  roles: [
    ...
    { id: "Medical", label: "Medical", isPrimary: false, briefing: "You're monitoring the scientist's physical condition as they work. Your goal: Ensure they take breaks and don't overexert themselves." }
  ]
},
{ 
...
{ 
  ...
  roles: [
    ...
    { id: "MedOfficer", label: "Medical Officer", isPrimary: false, briefing: "You're monitoring water reserves. Your goal: Track how much time they have before reserves run critically low." },
...
{ 
  ...
  roles: [
    ...
    { id: "FlightSurgeon", label: "Flight Surgeon", isPrimary: false, briefing: "You're establishing safety protocols. Your goal: Determine the minimum acceptable pressure for EVA." }
  ]
},
{ 
...
{ 
  ...
  roles: [
    ...
    { id: "ThermalEng", label: "Thermal Engineer", isPrimary: false, briefing: "You're monitoring the temperature climb in the bay. Your goal: Track how much time they have before damage occurs." },
...
{ 
  ...
  roles: [
    ...
    { id: "MedOfficer", label: "Medical Officer", isPrimary: false, briefing: "You're asking pointed questions about health symptoms. Your goal: Assess if there's a contamination risk." },
...
{ 
  ...
  roles: [
    ...
    { id: "MedOfficer", label: "Medical Officer", isPrimary: false, briefing: "You're establishing abort criteria based on safety margins. Your goal: Decide at what point they must return to the airlock." },
...
{ 
  ...
  roles: [
    ...
    { id: "MedOfficer", label: "Medical Officer", isPrimary: false, briefing: "You're tracking crew oxygen saturation levels. Your goal: Ensure the fluctuations aren't affecting crew health." },
...
{ 
  ...
  roles: [
    ...
    { id: "ImagingSpec", label: "Imaging Specialist", isPrimary: false, briefing: "You're suggesting sensor damage or lens defects. Your goal: Identify technical explanations for the artifact." },
...
{ 
  ...
  roles: [
    { id: "EnvTech", label: "Environmental Technician", isPrimary: true, briefing: "You're investigating the cold spot with no clear cause. Your goal: Find out why this section is losing heat." },
...
{ 
  ...
  roles: [
    ...
    { id: "MedOfficer", label: "Medical Officer", isPrimary: false, briefing: "You're suggesting testing crew members for illness or contamination. Your goal: Rule out human sources." },
...
{ 
  ...
  roles: [
    ...
    { id: "MedOfficer", label: "Medical Officer", isPrimary: false, briefing: "You're asking about vision symptoms and fatigue levels. Your goal: Determine if this is a medical issue." },
...
{ 
  ...
  roles: [
    ...
    { id: "MedOfficer", label: "Medical Officer", isPrimary: false, briefing: "You're asking detailed questions about memory continuity. Your goal: Assess if there are gaps in their recollection." }
  ]
},
{ 
...
{ 
  ...
  roles: [
    ...
    { id: "MedOfficer", label: "Medical Officer", isPrimary: false, briefing: "You're considering inner ear or vestibular issues. Your goal: Assess if this is a medical symptom." },
...
{ 
  ...
  roles: [
    ...
    { id: "MedOfficer", label: "Medical Officer", isPrimary: false, briefing: "You're monitoring heart rate and exertion levels. Your goal: Determine if this is causing physical strain." },
...
{ 
  ...
  roles: [
    ...
    { id: "MedOfficer", label: "Medical Officer", isPrimary: false, briefing: "You're asking about vertigo or balance symptoms. Your goal: Rule out vestibular or neurological issues." },
